...
int main(int argc, char** argv)
{
  ...
  name_distance=file_in.substr(0,file_in.rfind("_"));
  name_distance=name_distance+"_distance.png";

  name_intensity=file_in.substr(0,file_in.rfind("_"));
  name_intensity=name_intensity+"_intensity.png";

  name_rotation=file_in;

  ros::init(argc, argv, "velodyne_reconstruct");
  ros::NodeHandle np;
  printf("start\n");
  recon_frame=0;
