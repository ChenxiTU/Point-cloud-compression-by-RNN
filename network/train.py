...
parser.add_argument(
    '--train', '-f', type=str, default='../training_data/raw_decompose/distance/')
parser.add_argument(
    '--max-epochs', '-e', type=int, default=400, help='max epochs')
...
scheduler = LS.MultiStepLR(solver, milestones=[3, 10, 20, 50, 100, 200, 300], gamma=0.5)
...
for epoch in range(last_epoch + 1, args.max_epochs + 1):
    ...
    print('Epoch[{}] costs: {} mins'. format(epoch, interval))
